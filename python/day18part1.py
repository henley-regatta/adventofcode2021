#!/usr/bin/python3
# Python solution for AOC 2021 Day 18, Part 1
#
# Snailfish Homework Day.
#
# Snailfish count in Vectors. A number is either a "pair" - ordered list of
# 2 numbers or a scalar. Oh wow this is complicated.
#
# This whole thing is an exercise in pointless complexity and stupid arbitary
# rules piled on top of each other in as complex a way as is possible.
#
# Needless to say I hate it.
#
# When "I think it's easiest to leave it as a string and deal with each operation
# as a set of string manipulations" is the approach you arrive at **AFTER** trying
# to be A Bit More Clever With Understanding The Numbers, you know this is bloody
# painful.
        ...
        with open("data/day18part1.txt",'r') as sums :
            ...
            for l in sums :
                ...
                if acc=="" :
                    ...
                    acc = reduceNumber(addSnailFishNumbers(acc,number))
        print(f"Sum of numbers is: {acc}")
        print(f"Pointlessly Complicated Manipulations For Part One Yield Magnitude Result: {calcMagnitude(acc)}")
