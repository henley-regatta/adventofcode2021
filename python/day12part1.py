#!/usr/bin/python3
# Python solution for AOC 2021 Day 12, Part 1
#
...
def findRouteToEnd(routeSoFar) :
    ...
    #has not already been visited (isn't in the route)
